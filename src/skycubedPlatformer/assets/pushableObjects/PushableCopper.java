...
public class PushableCopper extends PushableObject {

	public PushableCopper(double x, double y, double size_x, double size_y) {
		super(x, y, size_x, size_y, GameObject.COLOR_COPPER, 8, 0.965);
	...
	@Override
	public void crush() {
		CoinParticle.spawnCoins(this.x, this.y, 1, 1);
		super.crush();
	}

...
public class PushableSilver extends PushableObject {

	public PushableSilver(double x, double y, double size_x, double size_y) {
		super(x, y, size_x, size_y, GameObject.COLOR_SILVER, 10.5, 0.965);
	...
	@Override
	public void crush() {
		CoinParticle.spawnCoins(this.x, this.y, 1, 5);
		super.crush();
	}
